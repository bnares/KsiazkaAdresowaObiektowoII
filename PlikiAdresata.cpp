...
int PlikiAdresata:: pobierzZPlikuIdOstatniegoAdresata()
{
...
void PlikiAdresata:: ustawIdOstatniegoAdresataPoUsunieciuWybranegoAdresata(int idUsuwanegoAdresata)
{
    if (idUsuwanegoAdresata == idOstatniegoAdresata)
    {

        int noweOstaatniAdresat =  pobierzZPlikuIdOstatniegoAdresata();

        ustawIdOstatniegoAdresata(noweOstaatniAdresat);
